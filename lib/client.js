...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const zh = {
			...
			"badge.quotaTitle": "Kimi 订阅：5 小时窗口剩余次数来自本机 Kimi Code OAuth 服务；官方未提供可靠的单轮消耗归因，故不显示消耗百分比",
			...
			"dock.quotaTitle": "Kimi 订阅 5 小时窗口：剩余次数来自本机 Kimi Code OAuth 服务，不把请求次数伪装成额度消耗",
			"summary.button": "额度汇总",
		...
		const en = {
			...
			"badge.quotaTitle": "Kimi subscription: the 5-hour remaining count comes from the local Kimi Code OAuth service; no reliable per-turn attribution is available, so no consumption share is shown",
			...
			"dock.quotaTitle": "Kimi subscription 5-hour window: remaining count comes from the local Kimi Code OAuth service; request counts are not presented as quota consumption",
